// When the factbutton button is pressed...
$("#factButton").on("click", function() {
	// We generate a random number between 0 and 6(the number of facts in the boofact array)...
	var number = Math.floor((Math.random() * booFactArray.length));
	// We display the fact from the array from the random position we just genereated...
	$("#factText").text(booFactArray[number])
})
// This array holds all of the boo facts ...
